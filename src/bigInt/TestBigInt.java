...
public class TestBigInt {
	...
	public static void main(String[] args) {
		...
		*/
		...
		BigInt l = new BigInt("34642636575423");
		BigInt m = new BigInt("23897546765");
		...
		*/
		...
		/*
		BigInt p = new BigInt("8");
		BigInt q = new BigInt("2");
		System.out.println(p.divide(q));
		
		BigInt n = new BigInt("16");
		BigInt o = new BigInt("2");
		System.out.println(n.divide(o));
		
		BigInt r = new BigInt("17");
		BigInt s = new BigInt("2");
		System.out.println(r.divide(s));
		
		BigInt t = new BigInt("-43623463");
		BigInt u = new BigInt("6");
		System.out.println(t.divide(u));
		
		BigInt v = new BigInt("3495871239074863489756");
		BigInt w = new BigInt("34279856348975");
		System.out.println(v.divide(w));
		
		BigInt x = new BigInt("43564356");
		BigInt y = new BigInt("34279856348975");
